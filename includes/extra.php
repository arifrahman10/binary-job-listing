<?php
//add_action('admin_init', 'binary_job_listing_repeater_meta_box', 2);


function binary_job_listing_repeater_meta_box() {
	add_meta_box( 'gpminvoice-group', 'Custom Repeatable', 'Repeatable_meta_box_display', 'bjl_post', 'normal', 'default');
}
